...
class DetectionResult:
    def __init__(self):
        self.center_x = 0.0  # 초기화
        self.center_y = 0.0  # 초기화
        self.blocks=[]
        self.count=0
    ...
    def detect_simple(
        ...
        source='7',  # file/dir/URL/glob/screen/0(webcam)
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            for i, det in enumerate(pred):  # per image
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    self.center_x=round(box_x+box_w/2,2)
                    self.center_y=round(box_y+box_h/2,2)
                    self.blocks.append(self.center_x)
